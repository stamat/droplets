...
```json
{
  ...
  "icon": [null, 0],
  "screenshots": [[], 0],
  "options": [{}, 0], // author-declared user-editable settings
  "menubar": [false, 0], // macOS NSStatusItem; also drops Dock tile with skip_taskbar
  "executable": ["main", 0],
  "origin": ["local", 0], // local | remote | hosted
  "source": ["index.html", 0],
  "skip_pager": [false, 0],
  "decorated": [false, 0],
  "skip_taskbar": [false, 0],
  "default_context_menu": [false, 0],
  "shape": ["rect", 0], // rect | roundedrect | circle | mask
  "corner_radius": [0, 0],
  "resizable": [false, 0],
  "screen": [0, 0],
  "y": [null, 0],
  "x": [null, 0],
  "stick": [false, 0], // show on all workspaces
  "below": [false, 0], // keep below other windows
  "above": [false, 0], // keep above other windows
  "drag": [false, 0],
  "hidden": [false, 0],
  "transparent": [false, 0],
  "opacity": [1, 0],
  "shape_mask": [null, 0], // PNG path for shape: mask (X11 SHAPE)
  "allowed_methods": [null, 0] // interwidget comm allowlist
}
```
...
```bash
sudo pacman -S python-gobject gtk3 webkit2gtk-4.1 python-cairo
```
